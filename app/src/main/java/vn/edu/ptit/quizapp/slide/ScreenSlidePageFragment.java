package vn.edu.ptit.quizapp.slide;
...
import vn.edu.ptit.quizapp.question.Question;
...
//    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        imgIcon.setImageResource(getResources().getIdentifier(getItem(mPageNumber).getImage()+"","drawable","vn.edu.ptit.quizapp"));
